...
- **활동 기반 새로고침** — Cursor를 사용하면 다음 폴링을 기다리지 않고 약 1분 내에 앱이 새로고침되어, 작업 직후에도 사용량이 최신 상태로 유지됩니다. 간격 폴링은 fallback으로 계속 동작합니다. 설정 → Refresh → "Refresh on Cursor activity"에서 켜고 끌 수 있습니다.
